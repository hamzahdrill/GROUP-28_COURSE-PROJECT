...
# ── 12. DEPLOYMENT & ACCESS ──
style_heading(doc, '12. Deployment & Access')
add_para(doc,
    'The complete project source code is hosted on GitHub and publicly accessible:')

add_para(doc, 'GitHub Repository:', bold=True)
add_para(doc, 'https://github.com/hamzahdrill/GROUP-28_COURSE-PROJECT')

add_para(doc, 'To clone and run locally:', bold=True)
add_para(doc,
...
add_para(doc, 'Repository contents:', bold=True)
add_table_from_data(doc,
    ['File', 'Description'],
    [
        ['main.py', 'FastAPI backend — 4 API endpoints + calculation engine'],
        ['database.py', 'SQLite database — feedstocks + calculation history'],
...
add_para(doc,
    ...
    'http://localhost:8000/docs when the server is running. This provides '
    'an interactive Swagger UI where all endpoints can be tested directly.')

# ── 13. HOW TO RUN ──
style_heading(doc, '13. How to Run')
add_para(doc,
...
# ── 14. CONCLUSION ──
style_heading(doc, '14. Conclusion')
add_para(doc,
    ...
    '• Source code deployed on GitHub for public access\n'
...
# ── 15. REFERENCES ──
style_heading(doc, '15. References')
refs = [
    ...
    'GitHub Repository. https://github.com/hamzahdrill/GROUP-28_COURSE-PROJECT',
]
